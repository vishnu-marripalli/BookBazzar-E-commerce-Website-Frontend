          ...
          <div className="w-full flex md:flex-row flex-col sm:py-10 py-3">
            <div className="md:w-[45%] md:p-2 flex flex-col ">
              ...
              <div className="flex flex-row h-auto w-full my-4 max-w-[400px] ">
                ...
                />
                <button
                  className="font-bold border-2 p-1 text-[12px] min-w-20 flex items-center justify-center sm:text-sm sm:p-[9px] border-white"
              ...
              <div className="flex  gap-2 ">
                <a
                  href="https://www.instagram.com/vish_nu0022"
                  className=""
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/vishnuvardhan-marripalli/"
                  className=""
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <a
                  href="https://github.com/vishnu-marripalli"
                  className=""
                  target="_blank"
                  rel="noopener noreferrer"
                >
